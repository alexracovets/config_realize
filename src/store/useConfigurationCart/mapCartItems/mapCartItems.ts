...
import { deriveLocalBusiness, randomId } from '@utils';

const createCartItem = (params: { collectionHandle: string; slug: string; modelId: modelIdType; business?: garmentBusinessType }): cartItemType => ({
  id: `cart-${params.collectionHandle}-${params.slug}-${randomId()}`,
