...
const styles = StyleSheet.create({
  ...
  logoFallback: { fontSize: 14, fontFamily: PDF_FONT_FAMILY, fontWeight: 700 },
  ...
  title: { fontSize: 21, fontFamily: PDF_FONT_FAMILY, fontWeight: 700, marginBottom: 15 },
  ...
  tableHeadText: { fontSize: 8, fontFamily: PDF_FONT_FAMILY, fontWeight: 700, textAlign: 'center' },
  tableCell: {
    borderWidth: 0.75,
    borderColor: COLOR_BORDER,
    paddingVertical: 6,
  ...
  totalsGrandLabel: { fontSize: 12, fontFamily: PDF_FONT_FAMILY, fontWeight: 700 },
  totalsGrandValue: { fontSize: 18, fontFamily: PDF_FONT_FAMILY, fontWeight: 700 },
