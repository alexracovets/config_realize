...
const variantTrigger = cva('font-inter', {
  variants: {
    variant: {
      ...
      position:
        'w-full h-10 max-xl:h-8 max-sm:h-8.75 justify-between border border-input-border rounded-[8px] max-xl:rounded-[6.5px] max-sm:rounded-[7.5px] px-3 max-xl:px-2.5 text-sm max-xl:text-[13px] bg-white text-default',
    },
  },
  defaultVariants: {
    variant: 'default',
