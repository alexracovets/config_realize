...
const AsideConfigurationUtility = () => {
  ...
  return (
    <aside className="p-4 pr-12 h-full max-sm:absolute max-sm:right-2 max-sm:top-7 max-sm:z-30 max-sm:h-auto max-sm:w-fit max-sm:px-1 max-sm:pb-2 max-sm:pt-0">
