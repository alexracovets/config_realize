...
const AsideConfigurationUtility = () => {
  ...
  return (
    <aside className="p-4 pr-12 h-full max-sm:col-start-3 max-sm:row-start-1 max-sm:h-auto max-sm:w-fit max-sm:shrink-0 max-sm:self-start max-sm:px-1 max-sm:pb-2 max-sm:pt-7">
