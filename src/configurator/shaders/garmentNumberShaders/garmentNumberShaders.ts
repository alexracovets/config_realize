const garmentNumberMapFragment = /* glsl */ `
  ...
  printColor = garmentCompositePrintElement( printColor, slotNumber0 );
  printColor = garmentCompositeGizmoFrame( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[0], uNumberScale[0], uNumberGizmoHalf[0], uGizmoRotation, uNumberPartRotation[0], uNumberGizmoEnabled * uNumberGizmoFrameActive[0], numberInside0 ) );
  ...
  printColor = garmentCompositePrintElement( printColor, slotNumber1 );
  printColor = garmentCompositeGizmoFrame( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[1], uNumberScale[1], uNumberGizmoHalf[1], uGizmoRotation, uNumberPartRotation[1], uNumberGizmoEnabled * uNumberGizmoFrameActive[1], numberInside1 ) );
  ...
  printColor = garmentCompositePrintElement( printColor, slotNumber2 );
  printColor = garmentCompositeGizmoFrame( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[2], uNumberScale[2], uNumberGizmoHalf[2], uGizmoRotation, uNumberPartRotation[2], uNumberGizmoEnabled * uNumberGizmoFrameActive[2], numberInside2 ) );
  ...
  printColor = garmentCompositePrintElement( printColor, slotNumber3 );
  printColor = garmentCompositeGizmoFrame( printColor, garmentGizmoFrameColor( vPrintUv, uNumberAnchorUv[3], uNumberScale[3], uNumberGizmoHalf[3], uGizmoRotation, uNumberPartRotation[3], uNumberGizmoEnabled * uNumberGizmoFrameActive[3], numberInside3 ) );
