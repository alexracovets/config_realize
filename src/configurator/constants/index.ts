...
const PATTERN_LAYER_COUNT = 3;
const NAME_SLOT_COUNT = 4;
const LOGO_SLOT_COUNT = 4;
const LOGO_SLOT_CAPACITY_STEPS = [4, 9, 16, 25, 36] as const;
const LOGO_SHADER_SLOT_COUNT = 16;
const LOGO_MAX_USER_FILES = LOGO_SHADER_SLOT_COUNT - 1;
const LOGO_STAMP_ATLAS_MAX_PX = 2048;
...
const NAME_GIZMO_BTN_HALF_ATLAS = 60 * NAME_GIZMO_UI_ATLAS_SCALE;
const NAME_GIZMO_BTN_OUTSET_ATLAS = 40 * NAME_GIZMO_UI_ATLAS_SCALE;
...
export {
  ...
  LOGO_SLOT_CAPACITY_STEPS,
  LOGO_SLOT_COUNT,
  LOGO_STAMP_ATLAS_MAX_PX,
